...
class Employee implements Cloneable{
	  ...
	  /*	object classes clone method is protected native class. the overriding method in any subclass should be 
	   *	==============protected native Object clone() throws CloneNotSupportedException;=======================
	   *    any update in the cloned Object will not be reflected in the original object and vice versa.
	   *    In reference assignment any update in the assignee will affect the original and vice versa.
	   *    =====================================================================================================
	   ...
	   *	While copying the object type field the reference is copied to Y i.e object Y 
	   *	will point to same location as pointed out by X. 
       ...
       *
			...
			then new copy of any referenced objects fields are created and these references
 			are placed in object Y. This means any changes made in referenced object fields
 			in object X or Y will be reflected only in that object and not in the other.
			...
			If we use copy constructor, then we have to copy all of the data over explicitly i.e.
 			we have to reassign all the fields of the class in constructor explicitly. 
